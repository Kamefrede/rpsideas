...
import xyz.kamefrede.rpsideas.compat.botania.BotaniaCompatPieces;
import xyz.kamefrede.rpsideas.spells.PieceCrossConnector;
import xyz.kamefrede.rpsideas.spells.PieceVectorCatch;
import xyz.kamefrede.rpsideas.spells.constant.PieceConstantTau;
import xyz.kamefrede.rpsideas.spells.operator.PieceOperatorGetDamage;
import xyz.kamefrede.rpsideas.spells.operator.PieceOperatorGetMetadata;
import xyz.kamefrede.rpsideas.spells.operator.block.*;
import xyz.kamefrede.rpsideas.spells.operator.energy.*;
import xyz.kamefrede.rpsideas.spells.operator.entity.*;
import xyz.kamefrede.rpsideas.spells.operator.list.PieceOperatorListExclusion;
import xyz.kamefrede.rpsideas.spells.operator.list.PieceOperatorListIntersection;
import xyz.kamefrede.rpsideas.spells.operator.list.PieceOperatorListSize;
import xyz.kamefrede.rpsideas.spells.operator.list.PieceOperatorListUnion;
import xyz.kamefrede.rpsideas.spells.operator.math.*;
import xyz.kamefrede.rpsideas.spells.operator.math.bitwise.*;
import xyz.kamefrede.rpsideas.spells.operator.string.*;
import xyz.kamefrede.rpsideas.spells.operator.vector.*;
import xyz.kamefrede.rpsideas.spells.selector.*;
import xyz.kamefrede.rpsideas.spells.trick.block.*;
import xyz.kamefrede.rpsideas.spells.trick.entity.*;
import xyz.kamefrede.rpsideas.spells.trick.misc.*;
