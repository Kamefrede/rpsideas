...
import xyz.kamefrede.rpsideas.spells.operator.vector.PieceOperatorVectorStrongRaycast;
...
public class PieceMacroCasterStrongRaycast extends SpellPiece {
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        ...
        RayTraceResult pos = PieceOperatorVectorStrongRaycast.raycast(context.caster.world, originVal, rayVal, maxLen);
        if (pos == null)
