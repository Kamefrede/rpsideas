...
import static com.github.kamefrede.rpsideas.spells.trick.block.PieceTrickConjureEtherealBlock.placeBlock;
...
public class PieceTrickConjureEtherealBlockSequence extends PieceTrick {
    ...
    public Object execute(SpellContext context) throws SpellRuntimeException {
        ...
        for(int i = 0; i < Math.min(len, maxBlocksInt); i++) {
            ...
            if(state.getBlock() != ModBlocks.conjuredEthereal) {
                ...
                if(!context.caster.getEntityWorld().isRemote && state.getBlock() == ModBlocks.conjuredEthereal) {
