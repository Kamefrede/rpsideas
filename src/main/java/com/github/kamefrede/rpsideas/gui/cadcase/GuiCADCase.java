...
public class GuiCADCase extends GuiContainer {
    private static final ResourceLocation textureMain = new ResourceLocation(Reference.MODID, "textures/gui/case_base.png");
    private static final ResourceLocation textureCase = new ResourceLocation(Reference.MODID, "textures/gui/cases.png");
