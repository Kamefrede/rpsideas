...
public class LayerAuthorCapeOthers implements LayerRenderer<EntityOtherPlayerMP> {
    ...
    public LayerAuthorCapeOthers(RenderPlayer renderPlayer) {
    ...
    private ResourceLocation getTexture(EntityOtherPlayerMP player) {
    ...
    @Override
    public void doRenderLayer(@Nonnull EntityOtherPlayerMP player, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        if (!isAuthor(player))
            return;
    ...
    private void doCapeRender(EntityOtherPlayerMP player, float partialTicks, float r, float g, float b, boolean hasCad) {
    ...
    private void doElytraRender(EntityOtherPlayerMP player, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale, float r, float g, float b, boolean hasCad) {
        ItemStack stack = player.getItemStackFromSlot(EntityEquipmentSlot.CHEST);
    ...
    private void doSkinOverlayRender(EntityOtherPlayerMP player, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale, float r, float g, float b, boolean hasCad) {
