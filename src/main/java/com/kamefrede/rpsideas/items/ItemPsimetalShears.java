...
public class ItemPsimetalShears extends ItemMod implements IPsiAddonTool { // TODO: 12/15/18 look at
    private static final String TAG_REGEN_TIME = "regenTime";
    public static String[] variants = {LibItemNames.PSIMETAL_SHEARS, LibItemNames.IVORY_SHEARS, LibItemNames.EBONY_SHEARS};
