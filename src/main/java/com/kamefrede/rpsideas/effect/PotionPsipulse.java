...
public class PotionPsipulse extends PotionPsiChange {
    ...
    public void performEffect(@Nonnull EntityLivingBase entity, int amplifier) {
        if (PotionMod.Companion.hasEffect(entity, RPSPotions.psishock) && PotionMod.Companion.getEffect(entity, RPSPotions.psishock) != null && getEffect(entity) != null) {
            PotionEffect shockEffect = PotionMod.Companion.getEffect(entity, RPSPotions.psishock);
